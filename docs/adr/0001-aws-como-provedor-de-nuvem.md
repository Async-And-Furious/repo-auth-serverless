...
**Contexto**
O Tech Challenge permite livre escolha de nuvem. Temos acesso a contas de nuvem via **login de aluno da FIAP** (AWS Academy/Educate), o que fornece créditos e acesso já provisionado à AWS sem necessidade de cartão de crédito pessoal ou setup de billing próprio.
...
- Já temos exposição a AWS Lambda/API Gateway pelo conteúdo do curso.
